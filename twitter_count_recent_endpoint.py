# Twitter Count Recent Endpoint Module
# Connect to the Twitter API Tweet Counts Recent endpoint
...
def bearer_oauth(r):
    ...
    r.headers["User-Agent"] = "v2RecentTweetCountsPython" # Parameterise?
    return r
